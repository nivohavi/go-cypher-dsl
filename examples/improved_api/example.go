...
func main() {
	fmt.Println("Go Cypher DSL - Improved API Examples")
	fmt.Println("====================================")
	...
	fmt.Println("1. Simple MATCH-RETURN:")
	...
	fmt.Println("2. MATCH-WHERE-RETURN with property comparison:")
	...
	fmt.Println("3. MATCH with relationship pattern:")
	...
	fmt.Println("4. Query with WITH clause and parameters:")
	...
	fmt.Println("5. Query with complex logical expressions:")
